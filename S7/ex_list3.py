...
# list comprehension / generare lista noua cu niste elemente de la o lista cu anumite reguli

#new_list1 = [i for i in temperaturi if i % 5 == 0 ]

#print(new_list1)

new_list2 = [abs(i) for i in temperaturi if i < 0 ]
